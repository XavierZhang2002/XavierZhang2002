...
Currently, I'm interested in **LLM Agents** and **Agentic post-training**, developing active information foraging and post-training methods for million-token text understanding at **Tencent WeChat** ([ICML 2026](https://xavierzhang2002.github.io/SCOUT-page/)).
